...
! function(e, t) {
    ...
    var p = function(n) {
        ...
        function xe(d, p, g, m, v, e) {
            return m && !m[C] && (m = xe(m)), v && !v[C] && (v = xe(v, e)), ce(function(e, t, n, i) {
                ...
                } else h = we(h === t ? h.splice(c, h.length) : h), v ? v(null, t, h, i) : I.apply(t, h)
            })
        }
    ...
    C.fn.extend({
        ...
        C.fn[i] = function(e, t) {
            ...
            return "Until" !== i.slice(-5) && (t = e), t && "string" == typeof t && (n = C.filter(t, n)), 1 < this.length && (j[i] || C.uniqueSort(n), I.test(i) && n.reverse()), this.pushStack(n)
        }
    });
    var R = /[^\x20\t\r\n\f]+/g;
    ...
    C.event = {
        ...
        special: {
            ...
            click: {
                ...
                _default: function(e) {
                    var t = e.target;
                    return he.test(t.type) && t.click && O(t, "input") && Q.get(t, "click") || O(t, "a")
                }
            },
            beforeunload: {
    ...
    function He(n, i, r, o) {
        ...
        var e, t, s, a, l, c, u = 0,
            ...
            d = i[0],
            p = y(d);
        if (p || 1 < f && "string" == typeof d && !v.checkClone && Le.test(d)) return n.each(function(e) {
            var t = n.eq(e);
        ...
        if (f && (t = (e = Ee(i, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
            ...
            if (a)
                for (c = s[s.length - 1].ownerDocument, C.map(s, Re), u = 0; u < a; u++) l = s[u], pe.test(l.type || "") && !Q.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
    ...
    C.extend({
        ...
        css: function(e, t, n, i) {
            var r, o, s, a = Y(t);
            return Qe.test(t) || (t = Ke(a)), (s = C.cssHooks[t] || C.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = Ue(e, t, i)), "normal" === r && t in Je && (r = Je[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), C.each(["height", "width"], function(e, l) {
        C.cssHooks[l] = {
            get: function(e, t, n) {
                if (t) return !Xe.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? tt(e, l, n) : le(e, Ge, function() {
                    return tt(e, l, n)
                })
            },
            set: function(e, t, n) {
    ...
    C.Animation = C.extend(dt, {
        ...
        prefilters: [function(e, t, n) {
            ...
            if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(d))
                for (i in f && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = m && m.display) && (c = Q.get(e, "display")), "none" === (u = C.css(e, "display")) && (c ? u = c : (fe([e], !0), c = e.style.display || c, u = C.css(e, "display"), fe([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === C.css(e, "float") && (l || (h.done(function() {
                        p.display = c
                    ...
                    for (i in g || fe([e]), Q.remove(e, "fxshow"), d) C.style(e, i, d[i])
    ...
    C.fn.extend({
        ...
        toggleClass: function(r, t) {
            ...
            return "boolean" == typeof t && s ? t ? this.addClass(r) : this.removeClass(r) : y(r) ? this.each(function(e) {
                ...
                else void 0 !== r && "boolean" !== o || ((e = bt(this)) && Q.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === r ? "" : Q.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, i = 0;
    ...
    C.ajaxSetup({
        ...
        if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = y(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Xt, "$1" + i) : !1 !== e.jsonp && (e.url += (St.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function() {
    ...
    return C.noConflict = function(e) {
        return x.$ === C && (x.$ = Gt), e && x.jQuery === C && (x.jQuery = Qt), C
    }, e || (x.jQuery = x.$ = C), C
}),
function(e, t) {
    ...
    var w = "carousel",
        ...
        M = function() {
            ...
            return e.next = function() {
                ...
                if (r = e === D ? (n = "carousel-item-left", i = "carousel-item-next", "left") : (n = "carousel-item-right", i = "carousel-item-prev", "right"), l && p(l).hasClass(L)) this._isSliding = !1;
    ...
    for (var X = "undefined" != typeof window && "undefined" != typeof document, Q = ["Edge", "Trident", "Firefox"], G = 0, J = 0; J < Q.length; J += 1)
        if (X && 0 <= navigator.userAgent.indexOf(Q[J])) {
            G = 1;
            break
        }
    var Z = X && window.Promise ? function(e) {
        var t = !1;
        return function() {
    ...
    var re = X && !(!window.MSInputMethodContext || !document.documentMode),
        oe = X && /MSIE 10/.test(navigator.userAgent);
    ...
    var je = X && /Firefox/i.test(navigator.userAgent);
    ...
    var We = {
            ...
            modifiers: {
                ...
                applyStyle: {
                    ...
                    fn: function(e) {
                        var t, n;
                        return Ie(e.instance.popper, e.styles), t = e.instance.popper, n = e.attributes, Object.keys(n).forEach(function(e) {
                            !1 !== n[e] ? t.setAttribute(e, n[e]) : t.removeAttribute(e)
                        }), e.arrowElement && Object.keys(e.arrowStyles).length && Ie(e.arrowElement, e.arrowStyles), e
                    },
                ...
                if (!this._element.disabled && !p(this._element).hasClass(Ke)) {
                    ...
                    if (c._clearMenus(), !t) {
                        ...
                        if (p(e).trigger(i), !i.isDefaultPrevented()) {
                            ...
                            "ontouchstart" in document.documentElement && 0 === p(e).closest(".navbar-nav").length && p(document.body).children().on("mouseover", null, p.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass(Xe), p(e).toggleClass(Xe).trigger(p.Event(Ye.SHOWN, n))
                        }
                    }
                }
            }, e.show = function() {
                if (!(this._element.disabled || p(this._element).hasClass(Ke) || p(this._menu).hasClass(Xe))) {
                    var e = {
                            relatedTarget: this._element
                        },
                        t = p.Event(Ye.SHOW, e),
                        n = c._getParentFromElement(this._element);
                    p(n).trigger(t), t.isDefaultPrevented() || (p(this._menu).toggleClass(Xe), p(n).toggleClass(Xe).trigger(p.Event(Ye.SHOWN, e)))
                }
            }, e.hide = function() {
                if (!this._element.disabled && !p(this._element).hasClass(Ke) && p(this._menu).hasClass(Xe)) {
                    var e = {
                        ...
                        t = p.Event(Ye.HIDE, e),
                        n = c._getParentFromElement(this._element);
                    p(n).trigger(t), t.isDefaultPrevented() || (p(this._menu).toggleClass(Xe), p(n).toggleClass(Xe).trigger(p.Event(Ye.HIDDEN, e)))
                }
            }, e.dispose = function() {
                ...
                if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
                    for (var t = [].slice.call(document.querySelectorAll(Ge)), n = 0, i = t.length; n < i; n++) {
                        ...
                        if (e && "click" === e.type && (s.clickEvent = e), o) {
                            var a = o._menu;
                            if (p(r).hasClass(Xe) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && p.contains(r, e.target))) {
                                var l = p.Event(Ye.HIDE, s);
                                p(r).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), t[n].setAttribute("aria-expanded", "false"), p(a).removeClass(Xe), p(r).removeClass(Xe).trigger(p.Event(Ye.HIDDEN, s)))
                            }
                        }
                    }
            ...
            return e.enable = function() {
                ...
                if (this._isEnabled)
                    if (e) {
                        ...
                        if (p(this.getTipElement()).hasClass(Lt)) return void this._leave(null, this);
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    }), p(r).addClass(Lt), "ontouchstart" in document.documentElement && p(document.body).children().on("mouseover", null, p.noop);
                    var c = function() {
                ...
                if (p(this.element).trigger(i), !i.isDefaultPrevented()) {
                    if (p(n).removeClass(Lt), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger.click = !1, this._activeTrigger[jt] = !1, this._activeTrigger[It] = !1, p(this.tip).hasClass(kt)) {
                ...
                this.setElementContent(p(e.querySelectorAll(".tooltip-inner")), this.getTitle()), p(e).removeClass(kt + " " + Lt)
                ...
                this.config.trigger.split(" ").forEach(function(e) {
                    if ("click" === e) p(i.element).on(i.constructor.Event.CLICK, i.config.selector, function(e) {
                        ...
                        var t = e === It ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN,
                            n = e === It ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT;
                ...
                var n = this.constructor.DATA_KEY;
                (t = t || p(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), p(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusout" === e.type ? jt : It] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = "out", t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function() {
    ...
    p(window).on(Jt.LOAD_DATA_API, function() {
        ...
        return p.fn[Vt] = Xt, on._jQueryInterface
    };
    var sn = "bs.tab",
        an = "." + sn,
        ln = p.fn.tab,
